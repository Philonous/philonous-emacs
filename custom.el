...
(fn _)"]
 ...
 '(safe-local-variable-values
   '((sql-connection-alist
     ...
     (haskell-init--ide-mode . lsp)
     (haskell-init--ide-mode quote ghcide)
     (sql-connection-alist
      ("avancera-app"
       (sql-product 'postgres)
       (sql-user "avancera-app")
      ...
      ("avancera-app-test"
       ...
       (sql-database "postgres")
       (sql-port 5433)))
     (haskell-init--ide-mode . none)
     (haskell-init--ide-mode . hie)
     (haskell-init--ide-mode . ghcide)
     (haskell-init--ide-mode . intero)
     (sql-connection-alist
      ("avancera-app"
       (sql-product 'postgres)
       (sql-user "avancera-app")
       ...
       (sql-database "avancera-app")
       (sql-port 5432)))
     (intero-targets "test-server:lib" "test-server:test:integration" "test-server:test:tests")
