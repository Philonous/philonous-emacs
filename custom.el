(custom-set-faces
 ...
 '(flymake-error ((t (:underline (:style wave :color "red") :background "#43193dfb3dfb"))))
 '(flymake-note ((t (:underline (:style wave :color "blue") :background "#3dfb3dfb4319"))))
 '(flymake-warning ((t (:underline (:style wave :color "orange") :background "#4319414b3dfb"))))
 '(font-lock-comment-face ((t (:inherit font-lock-comment))))
 '(font-lock-function-name-face ((t (:inherit font-lock-string :underline t))))
 '(font-lock-keyword-face ((t ((font-lock-keyword) nil "#F0DFAF" :inherit (:color foreground-color :style line) :foreground :weight bold))))
...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("ec5f697561eaf87b1d3b087dd28e61a2fc9860e4c862ea8e6b0b77bd4967d0ba"
     ...
     "5ad69aca83efd8658fb11019c476d13b8b62422c6446220b1e90d6ef9dfd4498"
 ...
 '(haskell-process-args-stack-ghci
   '("--ghci-options=-ferror-spans -fdiagnostics-color=never" "--color"
     "never"))
 '(haskell-process-log t)
 '(haskell-process-path-cabal "cabal")
 '(haskell-process-path-cabal-ghci "cabal" t)
 ...
 '(sp-ignore-modes-list '(minibuffer-inactive-mode emacs-lisp-mode))
 '(sql-connection-alist
